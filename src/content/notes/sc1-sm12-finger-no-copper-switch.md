...
다음 그림은 이 프로젝트의 `l5x-ld-studio`와 같은 RLL 파서·LD 렌더링 로직으로 만들었다. 모든 그림의 파서 경고는 0건이었다. [l5x-ld-studio 열기](https://alzza.github.io/l5x-ld-studio/)

### 변경 전

![변경 전 Finger 완료 Rung](/images/notes/sc1-sm-finger-3mode/ld_rung_00.svg)
...
![변경 후 SM1 Finger 완료 Rung](/images/notes/sc1-sm-finger-3mode/ld_rung_01.svg)
...
![변경 후 SM2 Finger 완료 Rung](/images/notes/sc1-sm-finger-3mode/ld_rung_02.svg)
...
![60초 전용 버튼 LD](/images/notes/sc1-sm-finger-3mode/ld_rung_03.svg)

![60초 타이머 LD](/images/notes/sc1-sm-finger-3mode/ld_rung_04.svg)

![60초 뒤 모드 0 복귀 LD](/images/notes/sc1-sm-finger-3mode/ld_rung_05.svg)

모드 2는 `f_strip_failed`가 켜졌다는 이유만으로 우회하지 않는다. 실제 Retry 스텝이 실행되어 `f_auto_mode_manual_retry=1`이 된 순간부터 우회한다.

![실제 Retry 시작 기억 LD](/images/notes/sc1-sm-finger-3mode/ld_rung_06.svg)

![최종 우회 Active LD](/images/notes/sc1-sm-finger-3mode/ld_rung_07.svg)
